<?php
/*
Template Name: Региональная страница тротуарной плитки
*/
...
if (!$land76_region_title) {
  $land76_region_title = 'Укладка тротуарной плитки в ' . $land76_region_locative . ' под ключ — цена за м²';
}

if (!$land76_region_description) {
  $land76_region_description = 'Укладка тротуарной плитки в ' . $land76_region_locative . ' под ключ: основание, бордюры, уклоны, водоотвод, смета и монтаж.';
}

if (!$land76_region_lead) {
  $land76_region_lead = 'Делаем укладку тротуарной плитки в ' . $land76_region_locative . ': дорожки, двор, площадка под автомобиль, основание и водоотвод.';
}
...
$GLOBALS['land76wp_current_plitka_region_page'] = array(
...
function land76wp_get_current_plitka_region() {
  return isset($GLOBALS['land76wp_current_plitka_region_page'])
    ? $GLOBALS['land76wp_current_plitka_region_page']
    : null;
}
...
require get_template_directory() . '/category-89.php';
