...
<?php get_header('page'); ?>
        ...
        <div class="calc-seo__lead">
          ...
          <p>Для отмостки, ливневой канализации, осушения участка и автополива точные вкладки добавим позже, когда получим от клиента рабочие формулы. Сейчас по этим направлениям лучше перейти в подробные страницы услуг и оставить заявку на расчет.</p>
        ...
        <div class="calc-seo__faq">
          ...
          <div class="calc-seo__faq-grid">
            ...
            <div class="calc-seo__faq-item">
              ...
              <p>Сейчас доступны проектирование, дренаж, мощение и газон. Новые направления добавим после согласования формул расчета.</p>
            </div>
            <div class="calc-seo__faq-item">
      ...
      <script type="application/ld+json">
      {
        ...
        "mainEntity": [
          ...
          },
          {
            ...
            "acceptedAnswer": {
              "@type": "Answer",
              "text": "Сейчас доступны проектирование, дренаж, мощение и газон. Новые направления можно рассчитать через заявку после уточнения вводных."
            }
          },
          {
            "@type": "Question",
