<?php
/*
Template Name: Региональная страница автополива на участке
*/
...
if (!$land76_region_title) {
  $land76_region_title = 'Автополив на участке в ' . $land76_region_locative . ' под ключ - проект и монтаж';
}

if (!$land76_region_description) {
  $land76_region_description = 'Автополив на участке в ' . $land76_region_locative . ' под ключ: проектирование, монтаж, полив газона, капельный полив, насос и обслуживание.';
}

if (!$land76_region_lead) {
  $land76_region_lead = 'Делаем автополив на участке в ' . $land76_region_locative . ': проект, монтаж, полив газона, сада, теплицы, насосное оборудование и обслуживание.';
}
...
$GLOBALS['land76wp_current_autopoliv_region_page'] = array(
...
function land76wp_get_current_autopoliv_region() {
  return isset($GLOBALS['land76wp_current_autopoliv_region_page'])
    ? $GLOBALS['land76wp_current_autopoliv_region_page']
    : null;
}
...
require get_template_directory() . '/category-92.php';
