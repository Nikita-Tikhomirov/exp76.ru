<?php
/*
Template Name: Региональная страница ливневой канализации
*/
...
if (!$land76_region_title) {
  $land76_region_title = 'Ливневая канализация в ' . $land76_region_locative . ' под ключ - цена и монтаж';
}

if (!$land76_region_description) {
  $land76_region_description = 'Ливневая канализация в ' . $land76_region_locative . ' под ключ: дождеприемники, лотки, трубы, колодцы, отвод воды с крыши и участка.';
}

if (!$land76_region_lead) {
  $land76_region_lead = 'Делаем ливневую канализацию в ' . $land76_region_locative . ': отвод воды с крыши, дорожек и участка, дождеприемники, лотки, трубы и колодцы.';
}
...
$GLOBALS['land76wp_current_livnevka_region_page'] = array(
...
function land76wp_get_current_livnevka_region() {
  return isset($GLOBALS['land76wp_current_livnevka_region_page'])
    ? $GLOBALS['land76wp_current_livnevka_region_page']
    : null;
}
...
require get_template_directory() . '/category-91.php';
