<?php
/*
Template Name: Региональная страница осушения участка
*/
...
if (!$land76_region_title) {
  $land76_region_title = 'Осушение участка в ' . $land76_region_locative . ' под ключ - цена и работы';
}

if (!$land76_region_description) {
  $land76_region_description = 'Осушение участка в ' . $land76_region_locative . ' под ключ: убираем воду после дождей, заболачивание, мокрый грунт, подбираем дренаж и водоотвод.';
}

if (!$land76_region_lead) {
  $land76_region_lead = 'Делаем осушение участка в ' . $land76_region_locative . ': диагностируем причину воды, подбираем дренаж, лотки, уклоны и точку сброса.';
}
...
$GLOBALS['land76wp_current_osushenie_region_page'] = array(
...
function land76wp_get_current_osushenie_region() {
  return isset($GLOBALS['land76wp_current_osushenie_region_page'])
    ? $GLOBALS['land76wp_current_osushenie_region_page']
    : null;
}
...
require get_template_directory() . '/category-90.php';
