...
if ($cat87_region) {
    ...
    if (!empty($cat87_region['content'])) {
        $cat87_region_seo_content = $cat87_region['content'];
    } else {
...
<section class="advantages wrapper">
    ...
    <section class="services wrapper">
      ...
      <div class="services__cards columns3">
        ...
        $posts = get_posts(array(
          'numberposts' => -1,
          'post_type' => 'post',
          'post_name__in' => array('cena-drenazha-uchastka', 'vysokie-gruntovye-vody', 'glinistaya-pochva', 'vokrug-doma', 'glubinnyy', 'poverhnostnyy', '10-sotok', '6-sotok', 's-uklonom'),
    ...
    <section class="services wrapper casesCustom">
      ...
      <div class="services__cards columns3">
        ...
        <div style="width: 100%; text-align: center; padding: 30px 0;">
          <p>Материалы раздела готовятся. Сейчас можно выбрать нужную услугу выше и запросить расчет по участку.</p>
        </div>
        <?php } ?>
      </div>
    </section>
    ...
    <section class="services wrapper portfolio">
      ...
      <div class="price-example">
        ...
        <a href="<?php echo esc_url($cat87_prices_link_url ? $cat87_prices_link_url : '/cena-drenazha-uchastka/'); ?>" class="btn--outline-custom"><?php echo esc_html($cat87_prices_link_text ? $cat87_prices_link_text : 'Подробные цены'); ?></a>
      </div>
    </section>
    ...
    <section class="advantages wrapper">
      <div style="text-align: center; background: #f9f9f9; padding: 40px; border-radius: 10px;">
        ...
        <form class="cta-form form" id="calc" method="post" action="/server.php" style="display: flex; gap: 15px; justify-content: center; flex-wrap: wrap;">
          <?php land76_render_form_security_fields('legacy-category-87-cta-v3'); ?>
