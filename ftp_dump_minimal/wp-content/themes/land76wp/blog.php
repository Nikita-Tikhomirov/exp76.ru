...
<?php get_header('page'); ?>
      ...
      <section class="blog wrapper">
        ...
        <h2 class="blog__title">Полезная информация</h2>
        ...
        ?>
            ...
            <div class="post">
              ...
              <div class="post__img-wrap">
                <img class="post__img" src="<?php the_post_thumbnail_url(); ?>" alt="" role="presentation" />
              </div>
              ...
              <div class="post__text-wrap">
                ...
                <a class="post__btn" href="<?php the_permalink()?>">Подробнее</a>
