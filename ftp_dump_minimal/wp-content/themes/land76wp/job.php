...
<?php get_header('page'); ?>
      ...
      <section class="job wrapper">
        <h2 class="job__title">Текущие вакансии</h2>
        <div class="accardionJs">
          <div class="accardion__title">
            <p class="title">Требуются Бригады и специалисты-одиночки по укладке тротуарной плитки и благоустройству</p>
          </div>
          <div class="accardionContentJs">
            <p class="content-title">Укладка тротуарной плитки</p>
            <p class="content-subtitle">Требования:</p>
            <ul>
              <li>— опыт работы по укладке тротуарной плитки, клинкера от 2-х лет. Готовность работать на совесть!</li>
              <li>— наличие собственного инструмента (необязательно) и автомобиля</li>
            </ul>
            <p class="content-subtitle">Условия работы:
            <ul>
              <li>— работа по Рыбинске и Ярославской области;</li>
              <li>— при работе в области возможно проживание на объекте (зависит от объекта);</li>
              <li>— з/п сдельная. Работой обеспечим, главное Ваша сноровка и квалификация!</li>
            </ul>
            </p>
            <p class="content-subtitle">Обязанности:
            <ul>
              <li>— разбивка участка под укладку элементов мощения;</li>
              <li>— выставление уровней и уклонов;</li>
              <li>— все подготовительные работы перед укладкой (включая демонтаж старого покрытия);</li>
              <li>— установка садовых и дорожных бордюров;</li>
              <li>— укладка тротуарной плитки, брусчатки бетонной, клинкера;</li>
              <li>— выставление уклонов и монтаж системы водостока поверхностного или подземного залегания;</li>
              <li>— возможны сопутствующие уличные работы.</li>
            </ul>
            </p>
          </div>
        </div>
